...
rsync -avzu --exclude="*.avi" --exclude=".git" --exclude="records" --exclude="people" --include="*/"  --include="*.ini" --include="*.c" --include="*.sh" --include="*.py" --include="*.ino" --include='*.json' $BASEDIR/.. $REMOTE_SUB:/home/nanosub/proj/RovVision2/
sleep 2
