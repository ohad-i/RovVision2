...
rsync -avzu --exclude=".git" --exclude="records" --include="*/"  --include="*.ini" --include="*.c" --include="*.sh" --include="*.py" --include="*.ino" --exclude="*" $BASEDIR/.. $REMOTE_SUB:/home/nanosub/proj/RovVision2/
sleep 2
